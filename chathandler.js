...
const chat_names = ["Hulk","Thor","Iron Man","Captain America","I am Groot","Natasha","Dr Strange"];
const chat_names_length = chat_names.length;
const chat_msg = ["Thats my secret Captain, I'm always angry...",
    "Bring me Thanos...",
    "Love you 3000...",
...
class ChatHandler{
    ...
    createNode(id){
        ...
        chat_item.querySelector('#Image').src = "./images/avathar" + eval(1+(id%chat_img_length)) + ".png";
